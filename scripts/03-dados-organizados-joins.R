...
#Um conjunto de dados está em formato organizado para análise quando segue três regras simples:
  
 # cada coluna representa uma variável;
#cada linha representa uma observação;
#cada célula contém um único valor.
#Esse formato é importante porque facilita muito:
  
 # filtrar dados;
#selecionar variáveis;
#resumir informações;
#construir gráficos;
#e diversas outras operações importantes de análise de dados.
